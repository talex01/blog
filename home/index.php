...
foreach ($st->fetchAll() as $row) {
    ...
    <script>
        ...
        newContent.innerHTML = "<?php
            echo "<h2><a href='#'>{$row['title']}</a></h2><p class='lead'> by <a href='#'>Alexey Trushenko</a></p><p><span class='glyphicon glyphicon-time'></span> Posted on {$published_str}</p><hr>";
            ...
            echo "<hr><p>" . $c . " ...</p>";
            echo "<a class='btn btn-primary' href='../post/index.php?post=" . $row['id'] . "'>Read More <span class='glyphicon glyphicon-chevron-right'></span></a><hr>";
            ?>";
